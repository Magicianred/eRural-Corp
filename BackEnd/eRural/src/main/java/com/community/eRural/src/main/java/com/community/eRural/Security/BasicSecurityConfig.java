...
// Throws trata o erro ignorando as excessões
//csrf == Cross-Site Request Forgery (CSRF) 
 //@Bean Você está dizendo pro Spring que quer criar esse objeto e deixar ele
// disponível para outras classes utilizarem ele como dependência.